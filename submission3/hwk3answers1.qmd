...
format:
  pdf:
    output-file: "dharnidharka-r-hwk3-2"
    output-ext:  "pdf"
    header-includes:
      - \usepackage{float}
...
The estimate is -0.997, which is higher in magnitude than the estimate for 1970-1990. 
